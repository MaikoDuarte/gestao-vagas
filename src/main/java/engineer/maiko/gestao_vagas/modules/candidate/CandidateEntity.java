...
public class CandidateEntity {
  ...
  @Schema(example = "Maiko Duarte", requiredMode = RequiredMode.REQUIRED, description = "Nome do candidato")
  private String name;

  @NotBlank()
  @Pattern(regexp = "\\S+", message = "O campo [username] não deve conter espaço")
  @Schema(example = "maikoduarte", requiredMode = RequiredMode.REQUIRED, description = "Username do candidato")
  private String username;

  @Email(message = "O campo [email] não deve conter um e-mail valido")
  @Schema(example = "maiko@gmail.com", requiredMode = RequiredMode.REQUIRED, description = "Email do candidato")
